 ...
 <!-- Color Title --> 
  ...
  <section class="icons">
    ...
    <section class="top-icons clearfix">
      <div>
        <img class="top-icon1" src="assets/img/scarlet/icon1.png" alt="">
        <img class="top-icon2"src="assets/img/scarlet/icon2.png" alt="">
      </div>
      ...
      <div>
       ...
       <div>
        <img class="top-icon3" src="assets/img/scarlet/icon3.png" alt="">
        <img class="top-icon4" src="assets/img/scarlet/icon4.png" alt="">
      </div>
      <div>
