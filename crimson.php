 ...
 <!-- Color Title --> 
  ...
  <section class="icons">
    ...
    <section class="top-icons clearfix">
      <div>
        <img class="top-icon1" src="assets/img/crimson/icon1.png" alt="">
        <img class="top-icon2"src="assets/img/crimson/icon2.png" alt="">
      </div>
      ...
      <div>
       ...
       <div>
        <img class="top-icon3" src="assets/img/crimson/icon3.png" alt="">
        <img class="top-icon4" src="assets/img/crimson/icon4.png" alt="">
      </div>
      <div>
...
physically exhausting in large amounts. The original crimson was made from the shells of a Mediterranean insect - dried and smashed up and
