  ...
  <nav id="scroll-nav">
    <ul>
       <a href="mauve.php"><li class="mauve-nav nav">
       ...
       <a href="magenta.php"><li class="magenta-nav nav">
         <img class="top-title-line" src="assets/img/nav/nav-title-line.png" alt="title line">
